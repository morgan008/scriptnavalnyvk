...
// @downloadURL  https://github.com/topchik1/scriptnavalnyvk/raw/master/PixelBot.user.js
// @updateURL    https://github.com/topchik1/scriptnavalnyvk/raw/master/PixelBot.user.js
// @grant        none
// ==/UserScript==
...
function CoiPixelBot() {
    ...
    CoiPixelBot.url = {
        script: 'https://github.com/topchik1/scriptnavalnyvk/raw/master/PixelBot.user.js',
        image:  'https://raw.githubusercontent.com/topchik1/scriptnavalnyvk/master/image.png'
    };
    ...
    CoiPixelBot.reloadImage = function() {
        ...
        CoiPixelBot.img.onload = function() {
            CoiPixelBot.setState("Версия 3.6. Теперь с рандомом. Перезагрузил зону защиты.");
